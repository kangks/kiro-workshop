...
The Living Spec at `.kiro/specs/00-dvaia.living.md` is the **single source of truth** for this project.
...
└── 00-dvaia.living.md (🔵 Planning)
```

## Current Strategy

**Problem**: Modernize and harden the DVAIA (Damn Vulnerable AI Application) brownfield codebase
